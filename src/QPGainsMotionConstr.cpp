...
void BoundGainsConstr::updateNrVars(const std::vector<rbd::MultiBody>& /* mbs */, const tasks::qp::SolverData& data)
{
...
void MotionGainsConstr::computeTorque(const Eigen::VectorXd& alphaD, const Eigen::VectorXd& lambda)
{
	...
	constrData_->insertSpecificLines(constrData_->noGainsLinesList, constrData_->C, CSelect);
